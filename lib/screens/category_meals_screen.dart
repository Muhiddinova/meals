...
class CategoryMealsScreen extends StatelessWidget {
  ...
  const CategoryMealsScreen({Key? key, required this.toggleLike, required this.isFavorite}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: meals.length>0 ? ListView.builder(
          ...
          itemBuilder: (ctx, index)=>
             MealItem(meal: meals[index], toggleLike: toggleLike, isFavorite: isFavorite),
